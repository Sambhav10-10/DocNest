        ...
        {doctors.map((item, index) => (
          <div className='border border-[#C9D8FF] rounded-xl max-w-56 overflow-hidden group' key={index}>
            <div className='relative'>
              ...
              <button onClick={() => deleteDoctor(item._id)} className='absolute top-1 right-1 text-red-500 bg-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity'>
                &#10005;
              </button>
            </div>
            <div className='p-4'>
